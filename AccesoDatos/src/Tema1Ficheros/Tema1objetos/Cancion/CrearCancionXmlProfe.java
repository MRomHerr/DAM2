...
public class CrearCancionXmlProfe {

    public static void main(String[] args) throws IOException {

        //creamos variable fichero y flujo de lectura de fichero de objetos

        File f = new File("C:\\Users\\aludam2\\IdeaProjects\\DAM2\\AccesoDatos\\src\\Tema1Ficheros\\Tema1objetos\\Cancion\\FichCancion.dat");
        ...
        try
        {
            ...
            for(int i = 0; i < 5; i++)
            {
                ...
                crearElemento("Espanola",
                        Boolean.toString(cancion.getEspañol()),
                        raiz, document);
            ...
            Result result = new StreamResult(
                    new File("C:\\Users\\aludam2\\IdeaProjects\\DAM2\\AccesoDatos\\src\\Tema1Ficheros\\Tema1objetos\\Cancion\\Canciones.xml"));
